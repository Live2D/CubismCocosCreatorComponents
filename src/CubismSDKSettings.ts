...
namespace CubismSDKSettings {
  export function getShouldImportAsOriginalWorkflow(): Promise<boolean> {
    return Editor.Message.request(PLUGIN_NAME, 'getShouldImportAsOriginalWorkflow');
  }

  export function getShouldClearAnimationCurves(): Promise<boolean> {
